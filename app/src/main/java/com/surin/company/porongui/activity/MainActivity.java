...
import com.surin.company.porongui.UI.PlayBottomNavigation;
...
import com.surin.company.porongui.adapter.ViewPagerAdapter;
import com.surin.company.porongui.retrofit.ApiService;
import com.surin.company.porongui.retrofit.ApplicationController;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int oldClickSoundPosition = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundRecyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                ...
                Log.d(TAG, String.valueOf(e.getX()) + ", " + String.valueOf(e.getY()));
                if(child!=null&&gestureDetector.onTouchEvent(e)) {
                    ...
                    strTitle = soundListItemList.get(rv.getChildLayoutPosition(child)).getTitle();
                    clickSoundPosition = Integer.parseInt(soundListItemList.get(rv.getChildLayoutPosition(child)).getNum());
